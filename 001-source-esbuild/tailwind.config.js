  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: ({ theme }) => ({
        "linear-1": `linear-gradient(86deg, #016C51 -4.31%, #089874 48.45%, #00543F 101.22%)`,
        "linear-2": `linear-gradient(90deg, #EED171 0%, #FFF8E4 32.83%, #B88732 100%)`,
      }),
      backgroundPosition: {
        "pos-100-0": "100% 0%",
      },
    ...
    plugin(function ({
      ...
      addComponents({
        ...
        ".body-0": {
          ...
          fontSize: "16px",
          [`@media (min-width: ${theme("screens.lg")})`]: {
            fontSize: "clamp(16px,calc(20/1920*100rem),calc(20/1920*100rem))", // 6xl
          },
          lineHeight: "140%",
        },
        ".body-1": {
